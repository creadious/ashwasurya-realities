    ...
    return (
        <section className="py-10 md:px-20 px-4">
            ...
            <div className="grid md:grid-cols-3 grid-cols-2 md:grid-rows-4 md:gap-5 gap-1 md:text-base text-xs">
                ...
                <Link to={`/projects/ruthvi`} className="min-h-24 relative col-span-2 overflow-hidden">
                    ...
                    <div className="absolute text-sm md:bottom-2 md:right-2 bottom-1 right-1">
                        <Link to={`/projects/ruthvi`} className="flex items-center gap-1 hover:outline outline-1 hover:bg-white px-2 py-1 md:text-base text-[10px]">EXPLORE <BiSolidRightArrow className="text-slate-500" /></Link>
                    </div>
                ...
                <Link to={`/maintenance`} className="min-h-48 relative row-span-4 overflow-hidden">
                ...
                <Link to={`/maintenance`} className="relative md:row-span-2 overflow-hidden">
                    ...
                    <div className="absolute md:bottom-20 bottom-6 md:left-5 left-2 text-white md:block">
                        <h2 className="md:text-2xl text-[10px] font-bold md:leading-5 leading-3">
                ...
                <Link to={`/projects/atharva`} className="min-h- relative row-span-3 overflow-hidden">
                    <img src={image4} alt="" className="w-full h-full hover:scale-105 duration-200 object-cover" />
                    <div className="absolute text-sm md:bottom-2 md:right-2 bottom-1 right-1">
                        <Link to={`/projects/atharva`} className="flex items-center gap-1 hover:outline outline-1 text-white hover:text-black hover:bg-white px-2 py-1 md:text-base text-[10px]">EXPLORE <BiSolidRightArrow className="text-slate-500" /></Link>
                    </div>
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 md:top-5 top-2 text-white">
                        <div className="text-center font-bold">
                            ...
                            <h2 className="md:text-4xl text-sm text-nowrap">ATHARVA RITEWAY</h2>
                        </div>
                        <div className="flex items-center justify-center gap-1 md:mt-3">
                            <FaLocationDot className="text-red-700" />
                            <span>
                ...
                <Link to={`/maintenance`} className="relative overflow-hidden md:col-span-1 col-span-2">
