        ...
        <section
            ...
            <div className="grid md:grid-cols-2 grid-cols-1">
                <div className="md:order-1 order-2">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.8378966787077!2d77.51803467479296!3d12.91813821604875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3f8e148034c7%3A0xbdd59f800d23460c!2sAshwasurya%20Realities%20India%20Private%20Limited!5e0!3m2!1sen!2sin!4v1705068559995!5m2!1sen!2sin" className="w-full md:h-full h-60" loading="lazy" ></iframe>
                </div>
                <div className="md:order-2">
                    <form ref={form} onSubmit={handleSubmit} className="py-16 px-10 bg-black text-white flex flex-col items-start gap-5">
                        <input type="text" name="name" placeholder='name' className='bg-transparent border px-2 py-1 w-full' required />
                        <input type="email" name="email" placeholder='email' className='bg-transparent border px-2 py-1 w-full' required />
                        <input type="number" name="contact" placeholder='contact' className='bg-transparent border px-2 py-1 w-full' required />
