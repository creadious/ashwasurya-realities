        ...
        <section
            ...
            <div className="grid md:grid-cols-2 grid-cols-1">
                ...
                <div className="md:order-2">
                    <form onSubmit={handleSubmit} className="py-16 px-10 bg-black text-white flex flex-col items-start gap-5">
                        ...
                        <input type="number" name="phone" placeholder='contact' className='bg-transparent border px-2 py-1 w-full' required />
