    ...
    <section className=" md:px-20 px-2 py-14">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-10">
        <div className="h-full">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3522.324210066634!2d77.4588277!3d12.6941617!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae455202a206a5%3A0x4e0385c8a50f37b6!2sAshwasurya%20Finest!5e1!3m2!1sen!2sin!4v1773576111655!5m2!1sen!2sin"
              ...
              <div className="grid grid-cols-4 gap-y-10 p-5 py-10 items-center">
                ...
                <div>
                  <img
                    ...
                    className="h-10 object-contain mx-auto"
                  />
                  <h3 className="mt-1 text-sm text-center">24/7 Security</h3>
                </div>
                {/* <div>
                  <img
                    src={overtank}
                ...
                <div>
                  ...
                  <div className="mt-2 px-4">
                    <ul className="list-disc text-xs space-y-1">
                      <li>Dayanand Sagar University – 4 kms</li>
                      <li>Jain University (Deemed to be) – 6 kms</li>
                      <li>Jain International Residential School – 6 kms</li>
                      <li>Nanda Gokula Vidya Kendra – 3.5 kms</li>
                      <li>Green Bell High School – 3.5 kms</li>
                    </ul>
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2 px-4">
                    <ul className="list-disc text-xs space-y-1">
                      <li>Jollywood Studios – 10 kms</li>
                      <li>Eagleton the Golf Resort – 15 kms</li>
                      <li>Pyramid Valley – 8 kms</li>
                    </ul>
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2 px-4">
                    <ul className="list-disc text-xs space-y-1">
                      <li>Dayanand Sagar Institute of Medical Science – 3.9 kms</li>
                      <li>Nayak Multispeciality Hospital – 5 kms</li>
                      <li>Community Health Centre Harohalli – 2 kms</li>
                    </ul>
                  </div>
                </div>
                <div>
                  ...
                  <div className="mt-2 px-4">
                    <ul className="list-disc text-xs space-y-1">
                      <li>Upcoming Metro Extension to Harohalli</li>
                      <li>KSRTC Bus Stop – 0.5 km</li>
                      <li>NICE Road – 18 kms</li>
                    </ul>
                  </div>
                </div>
              </div>
