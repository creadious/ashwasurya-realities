import bannerImageDesk from "../../../assets/project/Finest/image back finest.webp";
import bannerImageMob from "../../../assets/project/Finest/image mob finest.webp";
  ...
  return (
    <section className="md:h-auto h-[36rem] relative">
      <div className="absolute md:top-5 top-2 md:left-5 left-2">
        <Link to="/">
          <img src={logo} alt="logo" className="md:w-40 w-10" />
        </Link>
      </div>
      <img
