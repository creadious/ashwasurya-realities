        ...
        <footer className='md:px-20 px-4 py-10 bg-black text-white'>
            ...
            <div className='mt-20 flex md:items-end gap-10 justify-between md:flex-row flex-col'>
                ...
                <div className='flex gap-8 items-center'>
                    ...
                    <a href="https://linkedin.com/company/ashwasurya-realities-company" target='_blank' title='Linkedin' className='w-10 h-10 rounded-full bg-white grid place-content-center text-3xl overflow-hidden'>
                        <FaLinkedin className='text-blue-700' />
                    </a>
                    <a href="https://www.youtube.com/@ashwasuryarealities3542" target='_blank' title='Youtube' className='w-10 h-10 rounded-full bg-white grid place-content-center text-3xl overflow-hidden'>
                        <FaYoutube className='text-red-600' />
                    </a>
                    <a href="https://www.instagram.com/ashwasurya_realities/" target='_blank' title='Instagram' className='w-10 h-10 rounded-full bg-white grid place-content-center text-3xl overflow-hidden'>
